...
<p>
  <h1> <strong>TC Pricing Table Pro</strong></h1>
  <br>
<a class="tc-button tc-btn-green" href="https://www.themescode.com/items/tc-pricing-table-pro/" target="_blank">Plugin Home</a>
<a class="tc-button tc-btn-blue" href="http://pricingtable.themescode.com/" target="_blank">Live Demo</a>
 <a class="tc-button tc-btn-lime" href="http://docs.themescode.com/tc-pricing-table-documentation" target="_blank">Documentation</a>
  <a class="tc-button tc-btn-blue" href="https://www.themescode.com/support/" target="_blank">Support</a>
 <a class="tc-button tc-btn-orange" href="https://goo.gl/PFkmUu" target="_blank">Learn WordPress</a>
</p>
<h4> TC Pricing Table Free Version Video Tutorial </h4>

<iframe width="660" height="415" src="https://www.youtube.com/embed/yUjna-qgz14" frameborder="0" allowfullscreen></iframe>
...
<li><span class="dashicons dashicons-arrow-right-alt"></span></i> And many more....</li>
  ...
  <a class="tc-button tc-btn-red"
    target="_blank" href="https://www.themescode.com/items/tc-pricing-table-pro">Upgrade To PRO !
  </a>
